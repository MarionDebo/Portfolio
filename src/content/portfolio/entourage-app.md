---
title: "Entourage App Redesign"
description: "Entourage is a French non-profit that fights social isolation by rebuilding human connections. The app was repositioned from donation-centric to a social connection platform, built around events, communities, and education."
year: 2023
tags: ["Mobile", "Social Impact"]
impact: "170,000 users on the app"
featured: true
order: 3
published: true
...
- **Events**: local gatherings organized by Entourage or volunteer ambassadors (coffee meetups, football, pétanque, art workshops). Any shared activity that creates a natural reason for neighbors and people in precarious situations to meet in the same space.
- **Communities**: local neighborhood groups where residents could connect, engage in conversations, and build ongoing relationships beyond a single event.
- **Educational content**: resources designed to break down prejudices about homelessness. Because connection starts with understanding. When people know more, they fear less, and they open up.

## Solution

A redesigned mobile app built around social connection. Users can discover and join local events in their neighborhood, participate in community groups, and access educational content about homelessness. The app transforms the relationship between volunteers and people in precarious situations: from giver/receiver to neighbor/neighbor.

## Impact

The redesigned app laid the foundation for Entourage's digital presence. Since the 2023 redesign, the platform has grown to reach:

- **170,000 users** registered on the app
- **4,300 community events** organized across **30 cities**
- **50,000 citizens** engaged alongside more than **13,000 people** in exclusion situations
- **79% of people supported** report feeling better as a result of the connections made

*Figures from entourage.social, reflecting the platform's cumulative growth since the redesign.*

## Conference Talk

*Title and link to be added.*
